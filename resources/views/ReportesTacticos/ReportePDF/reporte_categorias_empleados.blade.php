...
<head>
    ...
    <title>Demanda por categoría de empleados</title>
                    ...
                    <div style="display:flex; flex-direction: column; align-items:center; text-align:center;" >
                        <div class="row">
                            <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div>
                                    <h5>RPT03 - Demanda por categoría de empleados</h5>
                                    <br>
                                        <p>Reporte de las categorías de empleados y la demanda que poseen por rangos de tiempo </p>
                                ...
                                @foreach($categorias_empleados as $categorias)
                                    ...
                                    <span>Gráfico de categorías de empleado y cantidad de solicitudes</span>
                                    <br><br><br>
