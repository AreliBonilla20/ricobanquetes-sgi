@extends('layout')
@section('title')
Demanda por categoría de empleados
@endsection
@section('content')
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="data-table-list">
                    ...
                    <div class="col-12" style="text-align:center;">
                        ...
                        <p>Descripción : Reporte de las categorías de empleados y su demanda por rangos de tiempo.</p>
                    </div>
                    ...
                    <br><br>
                        <form style="padding-left:10%;" method="GET" action="{{route('consultar_categorias_empleados')}}">
