...
<head>
    ...
    <title>Reporte de ganancias totales</title>
                    ...
                    <div style="display:flex; flex-direction: column; align-items:center; text-align:center;" >
                        <div class="row">
                            <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div>
                                    <h5>RPE03 - Ganancias totales comparadas por período</h5>
                                    <br>
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                    ...
                                    <span><b>Tabla de ganancias totales del período {{$inicio_uno}} al {{$final_uno}} vs {{$inicio_dos}} al {{$final_dos}}</b></span>
                                    <br><br>
