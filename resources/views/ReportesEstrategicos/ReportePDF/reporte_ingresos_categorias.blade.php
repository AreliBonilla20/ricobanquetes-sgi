...
<head>
    ...
    <title>Reporte de ingresos por categoria de servicios comparadas por período</title>
                    ...
                    <div style="display:flex; flex-direction: column; align-items:center; text-align:center;" >
                        <div class="row">
                            <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div>
                                    <h5>RPE01 - Ingresos por categoría de servicios</h5>
                                    <br>
                                        <p>Reporte de la comparación entre períodos de tiempo de los ingresos por categoría de servicios </p>
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                    ...
                                    <span><b>Tabla de ingresos por categoría de servicios</b></span>
                                    <br><br>
