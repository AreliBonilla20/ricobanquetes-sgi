...
class IngresoCategoriaController extends Controller
{
    ...
    public function reporte(Request $request)
    {
        ...
        $pdf=PDF::loadView('ReportesEstrategicos/ReportePDF/reporte_ingresos_categorias', compact('inicio_uno', 'final_uno', 'inicio_dos', 'final_dos', 
        'inicio_uno_f', 'final_uno_f', 'inicio_dos_f', 'final_dos_f', 'categorias_ingresos_uno', 'categorias_ingresos_dos', 'categorias'));//Cargar la vista y recibe como parámetro el array de proyectos
